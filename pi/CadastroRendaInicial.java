 ...
 * @author Crawlers
 */
public class CadastroRendaInicial extends javax.swing.JDialog{

    /**
     * Creates new form CadastroRenda
     */
    public CadastroRendaInicial() {
        initComponents();
        ...
        this.setTitle("SoftMoney - Cadastro Inicial da Renda");
    }   

    private CadastroRendaInicial(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro Inicial da Renda", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Tahoma", 0, 18))); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(descricaotext, javax.swing.GroupLayout.DEFAULT_SIZE, 328, Short.MAX_VALUE)
                        .addGap(101, 101, 101))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        if(descricaotext.getText().isEmpty() && valortext.getText().isEmpty() && datatext.getText().equals("  /  /    ")){
            ...
            valortext.requestFocus();
                ...
                if(!data.find()){
                    ...
                    cadastroReceita.cadastroRendaInicial(descricao, valorFinal, periodo, categoria);
                    this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastroRendaInicial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CadastroRendaInicial dialog = new CadastroRendaInicial(new javax.swing.JFrame(), true);
